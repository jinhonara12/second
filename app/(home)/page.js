            ...
            <div className={styles.text_box}>
                ...
                <div className={styles.text}>
                    <span className={styles.en}>
                        New York, May 20, 1927 - The brave American aviator Charles Lindbergh successfully crossed the
                        Atlantic solo aboard the single-engine aircraft 'Spirit of St. Louis'. After a long 33-hour and
                        30-minute flight, he safely landed at Le Bourget Aerodrome in Paris on May 21, 1927....
                        <Link href="/about" title="about페이지로 이동">
                            more
                        </Link>
                    </span>
                </div>
