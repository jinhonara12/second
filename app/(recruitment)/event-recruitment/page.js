                            ...
                            return (
                                <li className={styles.list} key={index}>
                                    ...
                                    <div className={styles.link}>
                                        <a
                                            href={`/event-recruitment/${list.page_id}?name=${list.name}&year=${list.year}`}
                                        >
                                            상세페이지 <img src="/icons/link_24px.png" />
                                        </a>
                                        {list.home ? (
                                            <a href={list.home} target="_blank">
                                                홈페이지 <img src="/icons/link_24px.png" />
                                            </a>
                                        ) : (
                                            ""
                                        )}
