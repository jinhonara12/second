                                ...
                                <li className={styles.list} key={index}>
                                    <div className={styles.img_box}>
                                        ...
                                        <div className={styles.heart_box}>
                                            {(userInfo && <Heart id={list.page_id} page={userInfo.festArray} user_id={userInfo.page_id} />) || <Heart id={list.page_id} />}
                                        </div>
                                    </div>
                                    ...
                                    <div className={styles.link}>
                                        <a href={`/festival-recruitment/${list.page_id}?name=${list.name}&year=${list.year}`}>상세페이지 <img src="/icons/link_24px.png" /></a>
