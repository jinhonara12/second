                ...
                <div className={styles.about_box}>
                    ...
                    <div className={styles.item}>
                        ...
                        <div className={styles.right}>
                            <h3>마이페이지</h3>
                            <div className={styles.sub_text}>
                                <p>스윙데일리는 카카오 로그인을 통해서 최초 1회 가입이 진행됩니다. 고유 카카오ID 값으로 가입이 완료되며, 마이페이지 내에서 개인정보를 변경할 수 있습니다. 스윙과 관련된 정보를 남겨놓을 수 있으며 좋아하는 소식을 받아보기 위하여 좋아하는 바와 클럽을 저장할 수 있고 개별 모집 글에서 '좋아요'를 선택한 행사와 대회를 확인 할 수 있습니다.</p>
                            </div>
                        </div>
                    </div>
