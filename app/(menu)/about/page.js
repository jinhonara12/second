                    ...
                    <div className={styles.about_box}>
                        <div className={styles.item}>
                            ...
                            <div className={styles.right}>
                                ...
                                <div className={styles.sub_text}>
                                    <p>데일리스윙은 린디하퍼의 커뮤니티를 지향합니다.</p>
                                    <p>
                                        '동호회'와 '팀', '바' 그리고 각종 '대회', '행사' 모집 관련 게시글을 취합합니다.
                                    </p>
                        ...
                        <div className={styles.item}>
                            ...
                            <div className={styles.right}>
                                ...
                                <div className={styles.sub_text}>
                                    <p>
                                        - 'HOME'에서는 [7일 이내 마감되는 모든 모집글]과 [최근에 업데이트 또는 작성된
                                        모집글]이 각 5개씩 노출 됩니다.
                                    </p>
                                    <p>- 'ABOUT'은 스윙데일리의 구성과 설명 내용을 전달합니다.</p>
                                    <p>- 'BETA'는 홈페이지를 수정 및 추가하는 버전입니다.</p>
                                    <p>
                                        - 'CLUB', 'BAR'은 스윙 강습이 이뤄지는 동호회와 바의 기본적인 정보를 취급하고
                                        있습니다.
                                    </p>
                                    <p>- 'TEAM'은 모집을 진행하였던 스윙 팀을 소개하고 있습니다.</p>
                                    <p>
                                        - 'Class' / 'Team' / 'Workshop' / 'Event' / 'Festival' 모집 페이지는 sns 및
                                        동호회 카페에 업로드되어 있는 내용을 갈무리하여 노출시킵니다.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className={styles.item}>
                            ...
                            <div className={styles.right}>
                                ...
                                <div className={styles.sub_text}>
                                    <p>
                                        스윙데일리는 카카오 로그인을 통해서 최초 1회 가입이 진행되며, 마이페이지 내에서
                                        개인정보를 변경할 수 있습니다.
                                    </p>
                        ...
                        <div className={styles.item}>
                            ...
                            <div className={styles.right}>
                                ...
                                <div className={styles.sub_text}>
                                    <p>
                                        스윙에 대한 다양한 정보를 다루고 있습니다.{" "}
                                        <a href={process.env.GOOGLE_DATA_FORM} target="_blank">
                                            여기
                                        </a>
                                        를 클릭하셔서 스윙데일리를 업데이트 해주세요.
                                    </p>
                                    <p>
                                        스윙데일리는 수동으로 개별 데이터를 직접 입력하고 있어서 업데이트가 다소 늦을 수
                                        있는 점 양해바랍니다.
                                    </p>
                                </div>
                            </div>
